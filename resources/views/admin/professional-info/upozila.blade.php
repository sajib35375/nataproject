...
@section('content')
        ...
        <div class="row">
                        ...
                        <table class="table">
                            ...
                            @foreach($upozila as $d)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{ route('edit.pro.upozila',$d->id) }}">Edit</a>
                                        <a class="btn btn-danger" href="{{ route('delete.pro.upozila',$d->id) }}">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('store.upozila') }}" method="POST">
                            @csrf
    ...
    $(document).on('change','select[name="division_id"]',function (){
        ...
        if(id){
            $.ajax({
                url:"{{ url('select/pro/district') }}/"+id,
                method: "GET",
                dataType:"json",
