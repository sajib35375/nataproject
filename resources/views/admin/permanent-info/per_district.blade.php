        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            @foreach( $district as $d )
                                <tr>
                                    <td>{{ $loop->index+1 }}</td>
                                    <td>{{ $d->perdivision->division_name }}</td>
                                    <td>{{ $d->district_name }}</td>
                                    <td>
                                        <a class="btn btn-info" href="{{ route('per.district.edit',$d->id) }}">Edit</a>
                                        <a class="btn btn-danger" href="{{ route('per.district.delete',$d->id) }}">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('store.district.add') }}" method="POST">
                            @csrf
